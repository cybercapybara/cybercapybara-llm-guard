...
private:
    ...
    static void init_observability_(Config::AppConfig& cfg) {
        auto log_name = cfg.get<std::string>("logging.name", "LOG_NAME", "llm_guard");
        ...
        auto service_name = cfg.get<std::string>("observability.service_name", "SERVICE_NAME", "llm_guard_service");
    ...
    static void init_database_(Config::AppConfig& cfg) {
        ...
        // llm-guard Grafana dashboard. Same lifetime contract as retries_total.
