...
*/}}
{{- define "llm-guard-worker.fullname" -}}
...
Common labels.
*/}}
{{- define "llm-guard-worker.labels" -}}
helm.sh/chart: {{ include "llm-guard-worker.chart" . }}
{{ include "llm-guard-worker.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels.
*/}}
{{- define "llm-guard-worker.selectorLabels" -}}
app.kubernetes.io/name: {{ include "llm-guard-worker.name" . }}
...
*/}}
{{- define "llm-guard-worker.databaseEnv" -}}
- name: DATABASE_HOST
