...
helm.sh/chart: {{ include "llm-guard.chart" . }}
{{ include "llm-guard.selectorLabels" . }}
{{- if .Chart.AppVersion }}
...
Selector labels.
*/}}
{{- define "llm-guard.selectorLabels" -}}
app.kubernetes.io/name: {{ include "llm-guard.name" . }}
